...
export { default as cb } from './ChemistryBeaker'
export { default as db } from './DragonBall'
export { default as lf } from './LemonFruit'
export { default as pe } from './PlanetEarth'
export { default as sg } from './SunGlasses'
export { default as yw } from './YellowWallet'
