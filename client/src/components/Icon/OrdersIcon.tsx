  ...
  path: (
    <>
      <path
        ...
        fill="currentColor"
      />
      <path d="M8.25 7.25H16.75V9.375H8.25V7.25Z" fill="currentColor" />
      <path d="M8.25 11.5H16.75V13.625H8.25V11.5Z" fill="currentColor" />
      <path d="M8.25 15.75H13.5625V17.875H8.25V15.75Z" fill="currentColor" />
    </>
  ),
})
